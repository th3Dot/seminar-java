 ...
 * @author olda
 */
public class EditAuthorWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        windowLabel.setText("Edit existing author:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAuthorWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new EditAuthorWindow().setVisible(true);
            }
        });
    }
